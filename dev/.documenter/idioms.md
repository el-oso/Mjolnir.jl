...
# MATLAB → Julia idiom mapping {#MATLAB-Julia-idiom-mapping}

Normative MATLAB→Julia mappings. `✅` implemented · `🟡` partial/divergence · `⬜` planned. Canonical source: `src/idioms.jl`. Machine-readable mirror: `docs/idioms.json`.

## Literals & types {#Literals-and-types}
...
## Shapes & reductions {#Shapes-and-reductions}
...
## Constructors & builtins {#Constructors-and-builtins}
...
## Linear algebra & arrays {#Linear-algebra-and-arrays}
...
## Strings, conversions & maps {#Strings,-conversions-and-maps}
...
|   ✅ |                       `switch/case/otherwise` |                             `if/elseif/else` |                                                                                                                 `case {a,b}` -&gt; `sv == a |
