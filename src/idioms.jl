...
const IDIOMS = Idiom[
    ...
    Idiom("Constructors & builtins", "conv/conv2/filter/freqz/xcorr (DSP toolbox)", "DSP.conv/DSP.filt/...", builtin = :conv, notes = "DSP.jl"),
    ...
    Idiom("Control flow & functions", "[a,b,c]=deal(x) / [a,b]=deal(p,q)", "(a,b,c)=(x,x,x) / (a,b)=(p,q)", builtin = :deal, notes = "distributes inputs to outputs"),
